...
// Helper namespace for compile-time string operations
namespace {
...
// Cross-platform inline attribute
#ifdef _MSC_VER
...
// Base XOR string encryption class
...
public:
    ...
    // Get decrypted C-style string
    inline auto c_str() const {
        decrypt();
        return data;
    }

    // Get decrypted string object
...
private:
    ...
    // XOR key derived from compile time
...
// Operator overloads for encrypted strings
...
// Index list utilities for compile-time sequence generation
...
// Alternative XOR implementation with compile-time key
...
#define _(X, String) C_xor_ing<ConstructIndexList<sizeof(String)-1>::Result> X(String)
